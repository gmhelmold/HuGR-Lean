...
| TRS | `0175ae73f36709fd4a9242b2e431d026d6f82bb3` | MIT | selected native Cargo, pytest, Jest/Vitest, tsc, Git status, and search fixture bytes copied for WP3 verification; MIT notice retained in `docs/provenance/licenses/TRS-MIT.txt` | [TRS.md](TRS.md) |
...
Current incorporated fixture families:
...
- Git human status;
- grep/ripgrep search shapes.

Go and Docker/kubectl work used donor research but copied no donor fixture/runtime source for their WP3 implementations/coverage decisions.
