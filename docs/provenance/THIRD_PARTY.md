...
|---|---|---|---|---|
| RTK | `f5e104e117ab5b05c69d448103c28f1155e04417` | Apache-2.0 | research only; no source bytes copied yet | [RTK.md](RTK.md) |
...
| LeanCTX | `edd9c55650de4622e3a0cc8696bcf4e9abba1a6a` | Apache-2.0 | selective research only | [ADJACENT.md](ADJACENT.md) |
...
Apache-2.0 material must additionally preserve applicable notices and mark modified files as required by the license.
